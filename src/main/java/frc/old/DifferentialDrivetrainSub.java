...
public class DifferentialDrivetrainSub extends SubsystemBase {
    ...
    public void simulationPeriodic() {
        ...
        m_leftEncoderSim.setDistance(
                wheelMetersToEncoderDistance(m_driveSim.getLeftPositionMeters()));
        ...
        m_rightEncoderSim.setRate(
                wheelMPStoEncoderRPM(m_driveSim.getRightVelocityMetersPerSecond()));
    ...
    public Rotation2d getHeading() {
        /**
         * Gyroscopes in frc return positive values as you turn clockwise acording to the unit
         * circle this is backwards, thus we need to flip our gyro numbers.
         */
        if (Robot.isReal()) {

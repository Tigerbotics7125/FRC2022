...
public abstract class Curve {
   ...
   * https://www.desmos.com/calculator to see a visual representation of the <code>Curve</code>.
   *
  ...
  /**
   * Returns the value of <code>deadzone</code>, the value for the width in the center of the curve
   * where any input results in an output of <code>0.0</code>
   *
